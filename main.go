...
import (
	...
	imageserver_http "github.com/kapitoshka438/imgapi/imgapi-service/http"
	imageserver_http_crop "github.com/kapitoshka438/imgapi/imgapi-service/http/crop"
	imageserver_http_gamma "github.com/kapitoshka438/imgapi/imgapi-service/http/gamma"
	imageserver_http_gift "github.com/kapitoshka438/imgapi/imgapi-service/http/gift"
	imageserver_http_image "github.com/kapitoshka438/imgapi/imgapi-service/http/image"
	imageserver_image "github.com/kapitoshka438/imgapi/imgapi-service/image"
	imageserver_image_crop "github.com/kapitoshka438/imgapi/imgapi-service/image/crop"
	imageserver_image_gamma "github.com/kapitoshka438/imgapi/imgapi-service/image/gamma"
	_ "github.com/kapitoshka438/imgapi/imgapi-service/image/gif"
	imageserver_image_gift "github.com/kapitoshka438/imgapi/imgapi-service/image/gift"
	_ "github.com/kapitoshka438/imgapi/imgapi-service/image/jpeg"
	_ "github.com/kapitoshka438/imgapi/imgapi-service/image/png"
	"crypto/sha1"
	"crypto/sha256"
	"encoding/hex"
	"encoding/json"
...
func saveFile(w http.ResponseWriter, file multipart.File, handle *multipart.FileHeader) {
	...
	err = ioutil.WriteFile("./files/"+hashString+ext, data, 0666)
	if err != nil {
		fmt.Fprintf(w, "%v", err)
		return
	}
...
func loadImage(filename string, format string) image.Image {
	filePath := pathfile.Join("./files", filename)
...
func main() {
	...
	http.Handle("/files", newImageHTTPHandler())
	//http.Handle("/files", http.StripPrefix("/", newImageHTTPHandler()))
	http.HandleFunc("/", func(w http.ResponseWriter, r *http.Request) {
		...
		fmt.Println(path)
		http.ServeFile(w, r, dir+"/facade/"+path)
		//		http.ServeFile(w, r, "facade/")
	})
